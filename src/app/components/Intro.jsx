  ...
  return (
      <div className={`absolute w-[1400px] h-[617px] mt-[248px] ml-[250px] flex  `}>
        <div className="flex items-start justify-start flex-col">
            ...
            <p className={`absolute w-[383px] h-[120px] mt-[174px] ${poppins.className} font-[700] text-[100px]`}>UI & UX</p>
            <p className={`absolute w-[484px] h-[120px] mt-[269px] ml-[230px] ${poppins.className} font-[700] text-[100px] `}>Designer</p>
            ...
            <span className={` mt-[540px] ml-[7px]`}>
          <Button 
          title="Hire Me" 
          width="188px" 
          height="52px" 
